...
public class ImageController {
    ...
    public String showImage(@PathVariable("title") Integer imageId, String title, Model model) {
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model,HttpSession session) {
        ...
        if(imageUser==currentUser){     //Comments by Avia: This is the method to check if the currentUser is the same user who uploaded the image
